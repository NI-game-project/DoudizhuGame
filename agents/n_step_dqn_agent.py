...
from agents.buffers import NStepReplayBuffer
...
class NStepDQNAgent:
    ...
    def __init__(self,
        ...
        self.memory_buffer = NStepReplayBuffer(replay_memory_size, batch_size, self.n_step, self.gamma)
    ...
    def train(self):
        ...
        expected_q_values = rewards + self.gamma ** self.n_step * dones * next_q_values
