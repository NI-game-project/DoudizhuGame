...
class SimpleDoudizhuEnv(Env):
    ...
    def __init__(self, config):
        from simpledoudizhu.game import SimpleDoudizhuGame as Game
        from doudizhu.utils import encode_cards
        from doudizhu.utils import cards2str
        from doudizhu.utils import SPECIFIC_MAP, CARD_RANK_STR
        from simpledoudizhu.utils import ACTION_LIST, ACTION_SPACE
